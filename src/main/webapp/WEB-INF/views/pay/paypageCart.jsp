...
<script>
   ...
   $(function() {
	...
	const handleBank2 = (order_bankcode) => {
		event.preventDefault();
		console.log(order_bankcode);
		
		$("#payForm").attr("action", "paySuccess?order_bankcode="+order_bankcode);
               ...
               <div class="pay_content_left_way_content">
                 ...
                 <div class="pay_content_left_way_content_bank_1">
							<div id="card" role="group" class="btn btn-group-lg">
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('004')">
									<img src="resources/images/pay_bank/bank_kb.png">									
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('002')" >
									<img src="resources/images/pay_bank/bank_samsung.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('071')">
									<img src="resources/images/pay_bank/bank_hyundai.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('088')">
									<img src="resources/images/pay_bank/bank_shinhan.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('055')">
									<img src="resources/images/pay_bank/bank_lotte.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('011')">
									<img src="resources/images/pay_bank/bank_nh.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('050')">
									<img src="resources/images/pay_bank/bank_bc.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('027')">
									<img src="resources/images/pay_bank/bank_citi.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('090')">
									<img src="resources/images/pay_bank/bank_kakao.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('023')">
									<img src="resources/images/pay_bank/bank_sc.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('081')">
									<img src="resources/images/pay_bank/bank_hana.png">
								</button>
								<button type="button" class="bankbutton btn" name="order_bankcode" onclick="handleBank2('020')">
                     ...
                     <div id="deposit" style="display: none;" class="ml-5">
                        ...
                        <div class="form-group " style="width: 60%">
                           <label class="btn rmAudio"> 현금영수증 </label> <label
                              ...
                              name="order_bankcode" value="501" checked> 신청안함
                           </label>
                        </div>
                     </div>
