					...
					<a class="sabang_div3_move"
						...
						<c:if
							...
							<span class="price"> <text
									style="font-family: 'Cafe24Dangdanghae'; font-size:1.5em">&#8361;<fmt:formatNumber value="${sabang.sabang_price}" pattern="#,###"/></text></span>
						...
						<c:if test="${sabang.sabang_price == sabang.sabang_saleprice}">
							...
							<text style="font-family: 'Cafe24Dangdanghae'; font-size:1.5em">&#8361;&nbsp;</text><fmt:formatNumber value="${sabang.sabang_price}" pattern="#,###"/></span>
