...
<!-- palbang_create -->
	...
	<div class="palbang_create_main">
		<div class="palbang_create_title">
			<input class="palbang_create_txt" type="text" placeholder="제목을 입력하세요" name="title">
		</div>
		<div class="palbang_create_mainImage">
			<!-- 파일 업로드 박스 -->
			<h4 class="palbang_create_mainImage_img">대표이미지</h4>
			<div class="input-group mb-3">
				<input type="text" class="form-control" placeholder="사진을 첨부하세요" name="thumbnail">
				<div class="input-group-append">
				  <button class="btn btn-outline-secondary" type="button" id="button-addon2">사진 첨부하기</button>
				</div>
			  </div>
		</div>
		<div class="palbang_create_reviewSet">
			...
			<div class="palbang_create_reviewSet_right">
				<textarea class="form-control" placeholder="리뷰를 입력하세요." name="reviewTxt"></textarea>
			</div>
		</div>
		<div class="palbang_create_reviewSet_addSet">
			...
			<div class="palbang_create_reviewSet_addSet_addTxt">
				<button class="palbang_create_reviewSet_btn">추가하기</button>
			</div>
		</div>
