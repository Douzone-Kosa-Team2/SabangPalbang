...
<div class="palbang_detail_main">
	...
	<div class="palbang_detail_edit">
		<!-- <img id="heart_img" src="common/images/heart.png" alt="하트"/> -->
			...
			<svg id="svg1" onclick="addLike(${palbang.palbang_id})" style="margin-top: 7px; color: red;"
			...
			<svg id="svg2" onclick="deleteLike(${palbang.palbang_id})" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
				fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16"
				style="color: red; margin-top: 7px; display: none;">
