		...
		console.log("1");
	      ...
	      .then(data => {
	    	  ...
	    	  if(data.result == "success"){
	    		  console.log("3");
	    		  const str = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-heart-fill' viewBox='0 0 16 16' style='color: red;'>
