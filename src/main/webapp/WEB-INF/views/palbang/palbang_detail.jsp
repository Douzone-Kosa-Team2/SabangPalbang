...
<!-- 팔방 상세 페이지  -->
		...
		<div class="palbang_detail_edit">
			...
			<button onclick="addLike(${palbang.palbang_id})">
					<div id="EmptyHerat">
						...
						<c:if test="likeState==1">
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16" style="color: red;">
	...
	function addLike(palbang_id) {
		console.log(palbang_id);
	      ...
	      ajax.setRequestHeaer(header, token);
		   $.ajax({
	    	  	url: "likeUp",
				data: {palbang_id, header, token}, 
				method: "post",
